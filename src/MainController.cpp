...
MainController::MainController() : data(new Data) {
  ...
  // Setup font
  data->font = TTF_OpenFont("assets/fonts/PixelMplus12-Regular.ttf", 24);
  ...
  data->playerTex[1] = IMG_Load("assets/images/Player1.png");
  data->playerTex[2] = IMG_Load("assets/images/Player2.png");
  data->enemy1Tex = IMG_Load("assets/images/helicopter.png");
  data->enemy2Tex = IMG_Load("assets/images/bomber.png");
  data->enemy3Tex = IMG_Load("assets/images/ufo.png");
  for (int i = 0; i < 11; i += 1) {
    data->explodeTex[i] = IMG_Load(
        ("assets/images/explode" + std::to_string(i) + ".png").c_str());
  }

  // Setup sounds
  sound.registerSound("assets/sounds/Shoot.wav");   //   Id:0
  sound.registerSound("assets/sounds/Explode.wav"); // Id:1
  sound.registerSound("assets/sounds/Scored.wav");  //  Id:2
  sound.registerSound("assets/sounds/Fail.wav");    //    Id:3
}
